...
`proxy.js` at the project root handles request forwarding to the backend during local development. (Formly known as Next.js middleware; see the [migration note](https://nextjs.org/docs/messages/middleware-to-proxy).)
